...
\item
  Die Orientierung auf Angemessenheit und Designfragen spiegelt sich in der expliziten Anerkennung der \textbf{Rolle von Forschungsfragen} wider. In kaum einem anderen Bereich der sozialwissenschaftlichen Methodenlandschaft wird diesem Aspekt vergleichbar viel Aufmerksamkeit geschenkt.
\end{itemize}
...
\includegraphics[width=16.67in]{teacher_space}
